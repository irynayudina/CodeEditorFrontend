...
const ResizingWrapper = ({children}) => {
     const childrenArray = React.Children.toArray(children);
     const section1 = childrenArray[0];
     const section2 = childrenArray[1];
     const section3 = childrenArray[2];
  ...
  const section2HeightInit =
    (convertVhToPx(100) - horizontalLayoutOffset) * 0.75;
  const section3HeightInit =
    (convertVhToPx(100) - horizontalLayoutOffset) * 0.25;
